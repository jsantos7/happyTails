...
<html lang="en">
    ...
    <div id="carousel-divider"></div>
		...
		<h3 align="center" style="font-family: 'Fredericka the Great' , cursive; color: #b90504; font-size: 30pt; border-bottom: 2px solid #cccccc">Edit Pet Info</h3>
            ...
            <div class="col-lg-6">
                <div class="img-rounded" style="width: 500px; height: 520px; background-color: pink;">
                    <div class="row">
            ...
            <div class="img-rounded" style="width: 500px; height: 520px; background-color: pink;">
                ...
                <div class="col-lg-6" style="padding: 15px;">
                    ...
                    <div class="row">
                        <div class="col-lg-6" style="padding:10px">
                        <button type="submit" class="btn btn-lg btn-primary" name="submit">Edit Pet Information</button>
                    </div>
                    </div>
                </div>
            </div>
