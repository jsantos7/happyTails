...
$animalId = htmlentities($_GET['animal_id'], ENT_QUOTES, 'UTF-8');
$pet = Animal::getAnimalById($conn, $animalId);
$data = '';
if ($media = MediaExtractor::getMedia($conn, $pet['animal_id'], 'image')) {
    $data = @MediaExtractor::getThumbnail($media, 600, 420);
}
...
<html lang="en">
            ...
            <div class="jumbotron" style="margin: 0; height: 160px; padding: 15px;">
                <row>
                    <div class="col-lg-10 header-title">
                        <a href="index.php"><h1 style="font-family: 'Fredericka the Great' , cursive; color: #b90504; font-size: 70pt">Happy Tails</h1></a>
                    </div>
                    ...
                    <div id="navbar" class="nav navbar-collapse collapse active">
                        <div class="row">
                            <div class="col-sm-3 menu-item text-center">
                                <a href="#search.php" onclick="toggler('search-dropdown')">Search</a>                               
                            </div>
    ...
    <div id="carousel-divider"></div>
        ...
        <div class="container marketing">
            <div class="row">
                <h3 align="center" style="font-family: 'Fredericka the Great' , cursive; color: #b90504; font-size: 30pt; border-bottom: 2px solid #cccccc"><?php echo $pet['name']; ?></h3>
            </div>
            <div class="hor-divider"></div>

            <!-- CONTENT -->
            <div style="background-color: #f6f6f6; padding: 15px; border-radius: 15px;" class="row">
                <div class="col-lg-5">
                    <img src="data:<?php echo "{$media['filetype']}" . ';base64,'. base64_encode($data)?>" width="100%" height="100%"> 
                </div>
                <div class="col-sm-2">
                    <p style="float: right; font-size: 20pt">About:</p>
                </div>
                <div class="col-lg-5 pull-right">
                    <div class="row">
                        <p style="float: right; font-size: 18pt; text-align: left;">
                ...
                <div class="col-lg-5 pull-right">
                    <div class="row">
                        <div class="col-sm-6 pull-right adopt-button">
                            <?php echo '<a href="contact.php?animal_id=' . "{$pet['animal_id']} " . '">Adopt Me</a>';?>
                        </div>
                    </div>
                </div>
            </div>
            <div class="hor-divider"></div>
            <div class="row" style="font-size: 16pt; text-align: justify; margin-left: auto;">
                <p>Location:  <?php echo $pet['city'],', ',$pet['state'];?></p>
                <p>Breed:     <?php echo $pet['breed'];?></p>
                <p>Sex:       <?php echo $pet['sex'];?></p>
                <p>Age Group: <?php echo $pet['age'];?></p>
                <p>Color:     <?php echo $pet['color'];?></p>
                <?php if($pet['is_service_animal'] == 'yes'){echo'<p>'.$pet['name'].' is a service animal!</p>';}?>
            </div>      
        </div>
        </div>
        <div class="hor-divider"></div>
        ...
        <div class="container-fluid panel-footer footer" style="padding: 0">
            <div class="jumbotron" style="margin: 0; height: 140px; padding: 10px; background-color: #e8e8e8;">
                <div>
                    <a href="backend/search-filter.html">Search Filter</a>
                </div>
