...
<html lang="en">
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <div class="col-lg-12" align="center" style="padding-bottom: 20px;">
                <div class="img-rounded" style="width:1000px; height:330px; background-color: #e5e5e5;">
    ...
    <div class="container marketing">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="img-rounded" style="width:680px; height:260px; background-color: #e5e5e5;">
